...
export default function MiniUserProfile() {
    ...
    return (
        <div className="flex items-center mt-5 gap-3 changeScaleOnHoverDefaultStyle cursor-pointer" onClick={() => window.location.href = "/profile"}>
            <Image className="rounded-full h-12 w-12 object-cover" height={12} width={12} alt="Profile Image" src={loggedUserData?.profilePictureURL || "https://t4.ftcdn.net/jpg/02/29/75/83/360_F_229758328_7x8jwCwjtBMmC6rgFzLFhZoEpLobB6L8.jpg"} />
